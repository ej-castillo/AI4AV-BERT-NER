...
class Ner:
    ...
    def predict(self, text: str, start_idx: int = 0):
...
#                 output.append(' '.join(Organization) + ": Organization")
        ...
        output = []
        for i, (word, (label, confidence)) in enumerate(zip(words, labels)):
            if label != 'O':
                output.append((word, label, start_idx + i))
#                 output.append(word + ": " + label + " (" + "i)")
#             if label=="B-PER" or label=="I-PER":
#                 output.append(word + ": Person")
#             elif label=="B-LOC" or label=="I-LOC":
#                 output.append(word + ": Location")
#             elif label=="B-ORG" or label=="I-ORG":
#                 output.append(word + ": Miscelleneous Entity")
#             elif label=="B-MISC" or label=="I-MISC":
#                 output.append(word + ": Organization")
